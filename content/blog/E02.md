...
In the Docker Compose section, it is odd that they return to the bashrc and bash_aliases file. I think it might be advantageous to have this sooner or to leave out the previous section.[^2]
...
[^2]: would be a good thing to suggest upstream